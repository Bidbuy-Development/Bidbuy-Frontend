...
const Hero = () => {
  return (
    <section className="grid grid-rows-[1fr,minmax(200px,800px)] lg:grid-cols-2 justify-between items-center mx-auto max-w-[var(--container-max-width)] min-h-screen pt-20 sm:pt-24 lg:pt-28 py-5 gap-6">
      <section className="order-1 sm:order-2 self-center px-[var(--spacing-main-inline-padding)] flex flex-col items-start lg:order-none lg:justify-center lg:h-full">
        <h1
          className={`text-3xl font-bold sm:text-5xl lg:text-[75px] ${outfit.className}`}
        >
        ...
        <Link href="#" className="py-2.5 px-10 font-semibold">
          View Shop
        </Link>
      </section>
